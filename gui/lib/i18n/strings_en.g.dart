...
class TranslationsUiEn {
	...
	String get useAllowListScreenDescription => 'Specify ports, port ranges, or subnets to exclude from the VPN. Allowlist rules apply to both incoming and outgoing traffic. Any allowlisted traffic also falls outside Kill Switch protection.';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'ui.useAllowListScreenDescription': return 'Specify ports, port ranges, or subnets to exclude from the VPN. Allowlist rules apply to both incoming and outgoing traffic. Any allowlisted traffic also falls outside Kill Switch protection.';
