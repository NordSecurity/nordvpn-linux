...
final class SnapScreen extends ConsumerWidget {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(t.ui.weCouldNotConnectToService, style: errorScreenTheme.titleTextStyle),
              Padding(
                padding: EdgeInsets.only(top: appTheme.verticalSpaceSmall),
                child: ScalerResponsiveBox(
                  maxWidth: 262,
                  child: Text(
                    t.ui.tryRunningTheseCommands,
  ...
  List<CopyItem> _buildNeededCommands(List<String>? missingPermissions) {
    String commands = "";
    missingPermissions?.forEach((item) {
      commands = "${commands}sudo snap connect nordvpn:$item\n";
    });
