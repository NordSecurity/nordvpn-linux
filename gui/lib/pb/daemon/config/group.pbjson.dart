...
const ServerGroup$json = {
  ...
  '2': [
    ...
    {'1': 'THE_AMERICAS', '2': 21},
    {'1': 'ASIA_PACIFIC', '2': 23},
    {'1': 'AFRICA_THE_MIDDLE_EAST_AND_INDIA', '2': 25},
    {'1': 'DEDICATED_SERVERS', '2': 99},
  ],
};
...
final $typed_data.Uint8List serverGroupDescriptor = $convert.base64Decode(
    ...
    'APEg4KCk9CRlVTQ0FURUQQERIKCgZFVVJPUEUQExIQCgxUSEVfQU1FUklDQVMQFRIQCgxBU0lB'
    'X1BBQ0lGSUMQFxIkCiBBRlJJQ0FfVEhFX01JRERMRV9FQVNUX0FORF9JTkRJQRAZEhUKEURFRE'
    'lDQVRFRF9TRVJWRVJTEGM=');
