...
const DiagnosticsErrorCode$json = {
  ...
  '2': [
    ...
    {'1': 'DIAGNOSTICS_ERROR_CODE_NOT_SUPPORTED', '2': 8},
  ],
};
...
final $typed_data.Uint8List diagnosticsErrorCodeDescriptor = $convert.base64Decode(
    ...
    'Tk9TVElDU19FUlJPUl9DT0RFX05PX0RBRU1PTl9MT0dfU09VUkNFEAcSKAokRElBR05PU1RJQ1'
    'NfRVJST1JfQ09ERV9OT1RfU1VQUE9SVEVEEAg=');
...
final $typed_data.Uint8List serverGroupDescriptor = $convert
    .base64Decode('CgtTZXJ2ZXJHcm91cBISCgRuYW1lGAEgASgJUgRuYW1lSgQIAhAD');
