...
switch (_that) {
case _ApplicationSettings() when $default != null:
return $default(_that.notifications,_that.analyticsConsent,_that.autoConnect,_that.autoConnectLocation,_that.protocol,_that.killSwitch,_that.lanDiscovery,_that.routing,_that.postQuantum,_that.virtualServers,_that.firewall,_that.firewallMark,_that.customDns,_that.customDnsServers,_that.realTimeProtection,_that.tray,_that.allowList,_that.allowListData);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,notifications,analyticsConsent,autoConnect,autoConnectLocation,protocol,killSwitch,lanDiscovery,routing,postQuantum,virtualServers,firewall,firewallMark,customDns,const DeepCollectionEquality().hash(_customDnsServers),realTimeProtection,tray,allowList,allowListData);
