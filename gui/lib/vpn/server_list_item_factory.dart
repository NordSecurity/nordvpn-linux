...
final class ServerListItemFactory {
  ...
  Widget forRecent({
    ...
    final connectArgs = _buildRecentItemConnectArgs(
      recentConnection,
      isSpecialtyServer,
    );
    ...
    return CustomListTile(
      ...
      leading: ServerItemImage(
        image: _buildRecentItemImage(recentConnection, isSpecialtyServer),
      ),
      title: _buildRecentItemTitle(
        appTheme,
        recentConnection,
        isSpecialtyServer,
      ),
      onTap: () => onTapFunc(connectArgs),
    );
  }

  Widget _buildRecentItemImage(RecentConnection model, bool isSpecialtyServer) {
  ...
  ConnectArguments _buildRecentItemConnectArgs(
    RecentConnection model,
    bool isSpecialtyServer,
  ) {
