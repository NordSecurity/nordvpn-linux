...
// ForkNorduser manages norduser service through exec.Command
type ForkNorduser struct {
	cmd     *exec.Cmd
	logFile io.Closer
}
...
func (f *ForkNorduser) Enable(uid uint32, gid uint32) (err error) {
...
func (f *ForkNorduser) Stop(uid uint32) error {
