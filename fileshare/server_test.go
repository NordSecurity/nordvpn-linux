...
// }
//
// func TestAcceptFuseDestination(t *testing.T) {
// 	category.Set(t, category.Unit)
//
// 	transferID := exampleUUID
// 	filePath := "test_a.txt"
// 	peerIP := "10.0.0.5"
// 	peerReceivedDir := "peer_received"
//
// 	currentUserUID := uint32(1000)
// 	currentUserGID := uint32(1000)
// 	statCurrentUserOwner := &syscall.Stat_t{Uid: currentUserUID, Gid: currentUserGID}
//
// 	mockFs := newMockFilesystem()
// 	mockFs.MapFS["tmp"] = &fstest.MapFile{Mode: os.ModeDir | 0777, Sys: statCurrentUserOwner}
// 	mockFs.MapFS[peerReceivedDir] = &fstest.MapFile{Mode: os.ModeDir | 0777, Sys: statCurrentUserOwner}
//
// 	currentUserUIDStr := strconv.Itoa(int(currentUserUID))
// 	currentUserGIDStr := strconv.Itoa(int(currentUserGID))
// 	mockOsInfo := mockOsInfo{
// 		currentUser: user.User{Uid: currentUserUIDStr},
// 		groupIds:    map[string][]string{currentUserUIDStr: {currentUserGIDStr}},
// 	}
//
// 	tests := []struct {
// 		testName        string
// 		reqDstPath      string
// 		explicitPath    bool
// 		fuseMounter     *mockFuseMounter
// 		expectedDstPath string
// 	}{
// 		{
// 			testName:        "fuse mounted and no explicit path uses peer received dir",
// 			reqDstPath:      "tmp",
// 			explicitPath:    false,
// 			fuseMounter:     &mockFuseMounter{mounted: true, receivedDirs: map[string]string{peerIP: peerReceivedDir}},
// 			expectedDstPath: peerReceivedDir,
// 		},
// 		{
// 			testName:        "fuse mounted but explicit path overrides",
// 			reqDstPath:      "tmp",
// 			explicitPath:    true,
// 			fuseMounter:     &mockFuseMounter{mounted: true, receivedDirs: map[string]string{peerIP: peerReceivedDir}},
// 			expectedDstPath: "tmp",
// 		},
// 		{
// 			testName:        "fuse not mounted falls back to req dst path",
// 			reqDstPath:      "tmp",
// 			explicitPath:    false,
// 			fuseMounter:     &mockFuseMounter{mounted: false, receivedDirs: map[string]string{peerIP: peerReceivedDir}},
// 			expectedDstPath: "tmp",
// 		},
// 		{
// 			testName:        "no fuse mounter configured falls back to req dst path",
// 			reqDstPath:      "tmp",
// 			explicitPath:    false,
// 			fuseMounter:     nil,
// 			expectedDstPath: "tmp",
...
// 			Peer:      peerIP,
// 			Files:     []*pb.File{{Path: filePath}},
// 		}
// 		var fuseMounter FuseMounter
// 		if test.fuseMounter != nil {
// 			fuseMounter = test.fuseMounter
// 		}
//
// 		eventManager := EventManager{
// 			storage: &mockStorage{
// 				transfers: map[string]*pb.Transfer{transferID: &transfer},
// 			},
// 			filesystem:  &mockFs,
// 			osInfo:      &mockOsInfo,
...
// 				&pb.AcceptRequest{
// 					TransferId:   transferID,
// 					DstPath:      test.reqDstPath,
// 					ExplicitPath: test.explicitPath,
// 					Silent:       true,
// 					Files:        []string{filePath},
// 				},
// 				acceptServer)
// 			assert.NoError(t, err)
// 			assert.Equal(t, test.expectedDstPath, fileshare.lastAcceptDstPath)
// 		})
// 	}
// }
//
...
// }
//
// type mockFuseMounter struct {
// 	mounted      bool
// 	mountErr     error
// 	unmountErr   error
// 	receivedDirs map[string]string
// 	mountedPaths map[string]string
// }
//
// func (m *mockFuseMounter) Mount(mountpoint string) error {
// 	if m.mountErr != nil {
// 		return m.mountErr
// 	}
// 	m.mounted = true
...
// }
//
// func (m *mockFuseMounter) Unmount() error {
// 	if m.unmountErr != nil {
// 		return m.unmountErr
// 	}
// 	m.mounted = false
...
// }
//
// func (m *mockFuseMounter) IsMounted() bool {
// 	return m.mounted
// }
//
// func (m *mockFuseMounter) MountedPath(realPath string) (string, bool) {
// 	if !m.mounted {
// 		return "", false
// 	}
// 	mountedPath, ok := m.mountedPaths[realPath]
// 	return mountedPath, ok
// }
//
// func (m *mockFuseMounter) ReceivedDir(peerIP string) (string, error) {
// 	dir, ok := m.receivedDirs[peerIP]
// 	if !ok {
...
// 			isMeshEnabled: false,
// 			fuseMounter:   &mockFuseMounter{},
// 			mountPoint:    "/home/user/Meshnet",
// 			response:      serviceError(pb.ServiceErrorCode_MESH_NOT_ENABLED),
// 		},
// 		{
// 			testName:      "no fuse mounter configured",
// 			isMeshEnabled: true,
// 			fuseMounter:   nil,
// 			mountPoint:    "",
// 			response:      fileshareError(pb.FileshareErrorCode_MOUNT_FAILED),
// 		},
// 		{
// 			testName:      "already mounted",
// 			isMeshEnabled: true,
// 			fuseMounter:   &mockFuseMounter{mounted: true},
// 			mountPoint:    "/home/user/Meshnet",
// 			response:      fileshareError(pb.FileshareErrorCode_ALREADY_MOUNTED),
// 		},
// 		{
// 			testName:      "mount failure",
// 			isMeshEnabled: true,
// 			fuseMounter:   &mockFuseMounter{mountErr: errors.New("generic error")},
// 			mountPoint:    "/home/user/Meshnet",
// 			response:      fileshareError(pb.FileshareErrorCode_MOUNT_FAILED),
// 		},
// 		{
// 			testName:      "mount success",
// 			isMeshEnabled: true,
// 			fuseMounter:   &mockFuseMounter{},
// 			mountPoint:    "/home/user/Meshnet",
// 			response:      empty(),
...
//
// 		t.Run(test.testName, func(t *testing.T) {
// 			resp, err := server.Mount(context.Background(), &pb.Empty{})
// 			assert.NoError(t, err)
// 			assert.Equal(t, test.response, resp)
// 		})
// 	}
...
// 	}{
// 		{
// 			testName:    "not mounted",
// 			fuseMounter: &mockFuseMounter{},
// 			response:    fileshareError(pb.FileshareErrorCode_NOT_MOUNTED),
// 		},
// 		{
// 			testName:    "unmount failure",
// 			fuseMounter: &mockFuseMounter{mounted: true, unmountErr: errors.New("generic error")},
// 			response:    fileshareError(pb.FileshareErrorCode_LIB_FAILURE),
// 		},
// 		{
// 			testName:    "unmount success",
// 			fuseMounter: &mockFuseMounter{mounted: true},
// 			response:    empty(),
// 		},
// 	}
...
//
// 		t.Run(test.testName, func(t *testing.T) {
// 			resp, err := server.Unmount(context.Background(), &pb.Empty{})
// 			assert.NoError(t, err)
// 			assert.Equal(t, test.response, resp)
// 		})
// 	}
