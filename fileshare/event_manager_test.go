...
// }
//
// func TestFileDownloadedNotificationUsesMountedPath(t *testing.T) {
// XXX: bring it back
// transferID := exampleUUID
// fileID := "file_id"
// realPath := "/home/user/.config/nordvpn/meshnet-received/peer/received/file.txt"
// mountedPath := "/home/user/Meshnet/peer/received/file.txt"
//
// tests := []struct {
// 	name         string
...
// }{
// 	{
// 		name:         "no fuse mounter configured shows real path",
// 		fuseMounter:  nil,
// 		expectedBody: realPath,
// 	},
// 	{
// 		name:         "fuse mounted and path translatable shows mounted path",
// 		fuseMounter:  &mockFuseMounter{mounted: true, mountedPaths: map[string]string{realPath: mountedPath}},
// 		expectedBody: mountedPath,
// 	},
// 	{
// 		name:         "fuse mounted but path not translatable shows real path",
// 		fuseMounter:  &mockFuseMounter{mounted: true},
// 		expectedBody: realPath,
// 	},
// 	{
// 		name:         "fuse not mounted shows real path",
// 		fuseMounter:  &mockFuseMounter{mounted: false, mountedPaths: map[string]string{realPath: mountedPath}},
// 		expectedBody: realPath,
// 	},
// }
//
...
// 	eventManager.notificationManager = &notificationManager
// 	eventManager.SetFileshare(&mockEventManagerFileshare{})
// 	eventManager.fuseMounter = test.fuseMounter
// 	storage := &mockStorage{transfers: map[string]*pb.Transfer{}}
// 	eventManager.SetStorage(storage)
// 	storage.transfers[transferID] = &pb.Transfer{
// 		Id:     transferID,
// 		Status: pb.Status_ONGOING,
// 		Files: []*pb.File{
// 			{Id: fileID, FullPath: realPath, Status: pb.Status_ONGOING},
// 		},
// 		TotalSize:        1,
// 		TotalTransferred: 0,
// 		Direction:        pb.Direction_INCOMING,
...
//
// 		assert.Equal(t, 1, len(notifier.notifications))
// 		assert.Equal(t, test.expectedBody, notifier.notifications[0].body)
// 	})
// }
// }
//
