...
pushd "${current_dir}"
  ...
  lzo_cflags="-g -O2"
  lzo_ldflags=""
  openvpn_cflags="-Wall -Wno-unused-parameter -Wno-unused-function -g -O2 -D_FORTIFY_SOURCE=2 -std=c99 -fstack-protector -fstack-clash-protection -pie"
...
ln -fsnr "${output_dir}/.." "${current_version_dir}"
