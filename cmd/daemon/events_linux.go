...
func (*dummyAnalytics) Init(config.AnalyticsConsent) error                   { return nil }
...
func (*dummyAnalytics) NotifyPauseCancelled(events.DataPauseCancelled) error { return nil }
func (*dummyAnalytics) Stop() error                                          { return nil }
func (*dummyAnalytics) OnConfigChanged(config.DataConfigChange) error        { return nil }
