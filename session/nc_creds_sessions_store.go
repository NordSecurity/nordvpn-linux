...
func (s *NCCredentialsSessionStore) Renew() error {
	...
	if err := ValidateNCCredentials(resp.Username, resp.Password); err != nil {
		return err
	}

	if err := ValidateEndpoint(resp.Endpoint); err != nil {
		return err
	}
...
func (s *NCCredentialsSessionStore) validate() error {
	...
	if err := ValidateNCCredentials(cfg.Username, cfg.Password); err != nil {
		return err
	}
