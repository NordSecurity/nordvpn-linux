...
func file_service_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_service_response_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnabledStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_service_response_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_service_response_proto_msgTypes[4].OneofWrappers = []interface{}{
