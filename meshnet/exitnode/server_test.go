...
func TestResetPeersExitnode(t *testing.T) {
	...
	expectedCommands := []string{
		...
		// Delete old FORWARD rules for 70.19.250.31/32.
		"iptables -t filter -D FORWARD -s 70.19.250.31/32 -j ACCEPT -m comment --comment nordvpn",
		...
		// Delete old FORWARD rules for 202.242.38.68/32.
		"iptables -t filter -D FORWARD -s 202.242.38.68/32 -j ACCEPT -m comment --comment nordvpn",
		"iptables -t filter -D FORWARD -s 202.242.38.68/32 -d 10.0.0.0/8 -j ACCEPT -m comment --comment nordvpn",
		"iptables -t filter -D FORWARD -s 202.242.38.68/32 -d 172.16.0.0/12 -j ACCEPT -m comment --comment nordvpn",
		"iptables -t filter -D FORWARD -s 202.242.38.68/32 -d 192.168.0.0/16 -j ACCEPT -m comment --comment nordvpn",
		"iptables -t filter -D FORWARD -s 202.242.38.68/32 -d 169.254.0.0/16 -j ACCEPT -m comment --comment nordvpn",
		...
		"iptables -t filter -I FORWARD -s 202.242.38.68/32 -d 10.0.0.0/8 -j ACCEPT -m comment --comment nordvpn",
		"iptables -t filter -I FORWARD -s 202.242.38.68/32 -d 172.16.0.0/12 -j ACCEPT -m comment --comment nordvpn",
		"iptables -t filter -I FORWARD -s 202.242.38.68/32 -d 192.168.0.0/16 -j ACCEPT -m comment --comment nordvpn",
		"iptables -t filter -I FORWARD -s 202.242.38.68/32 -d 169.254.0.0/16 -j ACCEPT -m comment --comment nordvpn",
...
func TestResetPeers_LANDiscoveryDisabled(t *testing.T) {
	...
	expectedCommands := []string{
		...
		"iptables -I FORWARD -s 202.242.38.68 -j ACCEPT -m comment --comment nordvpn -d 192.168.0.1/32",
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedCommands: []string{
				...
				"iptables -D FORWARD -s 202.242.38.68 -j ACCEPT -m comment --comment nordvpn -d 192.168.0.0/16",
				"iptables -I FORWARD -s 192.168.0.1 -j ACCEPT -m comment --comment nordvpn -d 192.168.0.1/32",
				"iptables -I FORWARD -s 192.168.0.3 -j ACCEPT -m comment --comment nordvpn -d 192.168.0.1/32",
				"iptables -I FORWARD -s 202.242.38.68 -j ACCEPT -m comment --comment nordvpn -d 192.168.0.1/32",
				"iptables -I FORWARD -s 192.168.0.1 -j ACCEPT -m comment --comment nordvpn -p tcp -m tcp --dport 1000",
...
func TestDisable(t *testing.T) {
	...
	commandExecutor.mockedOutputs["iptables -S"] = strings.Join(
		[]string{
			"-A INPUT -s 230.191.4.88/32 -m comment --comment nordvpn -j ACCEPT",
			"-A INPUT -s 22.232.81.241/32 -m comment --comment nordvpn -j ACCEPT",
			...
			"-A FORWARD -s 22.232.81.241/32 -d 169.254.0.0/16 -m comment --comment nordvpn -j ACCEPT",
			"-A FORWARD -s 22.232.81.241/32 -d 192.168.0.0/16 -m comment --comment nordvpn -j ACCEPT",
			"-A FORWARD -s 22.232.81.241/32 -d 172.16.0.0/12 -m comment --comment nordvpn -j ACCEPT",
			"-A FORWARD -s 22.232.81.241/32 -d 10.0.0.0/8 -m comment --comment nordvpn -j ACCEPT",
			"-A FORWARD -s 100.64.0.0/10 -d 169.254.0.0/16 -m comment --comment nordvpn -j DROP",
			"-A FORWARD -s 100.64.0.0/10 -d 192.168.0.0/16 -m comment --comment nordvpn -j DROP",
			"-A FORWARD -s 100.64.0.0/10 -d 172.16.0.0/12 -m comment --comment nordvpn -j DROP",
			"-A FORWARD -s 100.64.0.0/10 -d 10.0.0.0/8 -m comment --comment nordvpn -j DROP",
			"-A FORWARD -s 230.191.4.88/32 -m comment --comment nordvpn -j ACCEPT",
			"-A FORWARD -d 100.64.0.0/10 -m conntrack --ctstate RELATED,ESTABLISHED -m comment --comment nordvpn -j ACCEPT",
			"-A FORWARD -d 100.64.0.0/10 -m comment --comment nordvpn -j DROP",
			"-A FORWARD -s 100.64.0.0/10 -m comment --comment nordvpn -j DROP",
	...
	expectedCommands := []string{
		"iptables -S",
		"iptables -D FORWARD -s 100.77.148.168/32 -m comment --comment nordvpn -j ACCEPT",
		"iptables -D FORWARD -s 22.232.81.241/32 -d 169.254.0.0/16 -m comment --comment nordvpn -j ACCEPT",
		"iptables -D FORWARD -s 22.232.81.241/32 -d 192.168.0.0/16 -m comment --comment nordvpn -j ACCEPT",
		"iptables -D FORWARD -s 22.232.81.241/32 -d 172.16.0.0/12 -m comment --comment nordvpn -j ACCEPT",
		"iptables -D FORWARD -s 22.232.81.241/32 -d 10.0.0.0/8 -m comment --comment nordvpn -j ACCEPT",
		"iptables -D FORWARD -s 100.64.0.0/10 -d 169.254.0.0/16 -m comment --comment nordvpn -j DROP",
		"iptables -D FORWARD -s 100.64.0.0/10 -d 192.168.0.0/16 -m comment --comment nordvpn -j DROP",
		"iptables -D FORWARD -s 100.64.0.0/10 -d 172.16.0.0/12 -m comment --comment nordvpn -j DROP",
		"iptables -D FORWARD -s 100.64.0.0/10 -d 10.0.0.0/8 -m comment --comment nordvpn -j DROP",
		"iptables -D FORWARD -s 230.191.4.88/32 -m comment --comment nordvpn -j ACCEPT",
		"iptables -D FORWARD -d 100.64.0.0/10 -m conntrack --ctstate RELATED,ESTABLISHED -m comment --comment nordvpn -j ACCEPT",
		"iptables -D FORWARD -d 100.64.0.0/10 -m comment --comment nordvpn -j DROP",
		"iptables -D FORWARD -s 100.64.0.0/10 -m comment --comment nordvpn -j DROP",
		"iptables -t nat -S POSTROUTING",
