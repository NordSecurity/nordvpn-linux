...
type StatusResponse struct {
	...
	PausedAt                  int64                 `protobuf:"varint,19,opt,name=paused_at,json=pausedAt,proto3" json:"paused_at,omitempty"`
	PauseRemainingDurationSec int32                 `protobuf:"varint,20,opt,name=pause_remaining_duration_sec,json=pauseRemainingDurationSec,proto3" json:"pause_remaining_duration_sec,omitempty"`
}
...
func (x *StatusResponse) GetPausedAt() int64 {
	if x != nil {
		return x.PausedAt
	}
	return 0
...
func (x *StatusResponse) GetPauseRemainingDurationSec() int32 {
	if x != nil {
...
var file_status_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x13, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x75,
	...
	0x6e, 0x5f, 0x73, 0x65, 0x63, 0x18, 0x14, 0x20, 0x01, 0x28, 0x05, 0x52, 0x19, 0x70, 0x61, 0x75,
