...
type FeatureRequest struct {
	...
	Feature config.Feature `protobuf:"varint,1,opt,name=feature,proto3,enum=config.Feature" json:"feature,omitempty"`
}
...
func (x *FeatureRequest) GetFeature() config.Feature {
	if x != nil {
		return x.Feature
	}
...
var file_features_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x1a, 0x14, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x66, 0x65, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3b, 0x0a, 0x0e, 0x46, 0x65,
	0x61, 0x74, 0x75, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x07,
	0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x52, 0x07,
	0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_features_proto_goTypes = []interface{}{
	(*FeatureRequest)(nil), // 0: pb.FeatureRequest
	(config.Feature)(0),    // 1: config.Feature
}
var file_features_proto_depIdxs = []int32{
	1, // 0: pb.FeatureRequest.feature:type_name -> config.Feature
