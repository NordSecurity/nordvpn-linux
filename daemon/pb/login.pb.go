...
type LoginOAuth2Response struct {
	...
	Ulr    string            `protobuf:"bytes,2,opt,name=ulr,proto3" json:"ulr,omitempty"`
}
...
func (x *LoginOAuth2Response) GetUlr() string {
	if x != nil {
		return x.Ulr
	}
	return ""
...
var file_login_proto_rawDesc = []byte{
	...
	0x0a, 0x03, 0x75, 0x6c, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x6c, 0x72,
