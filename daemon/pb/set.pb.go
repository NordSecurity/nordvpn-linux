...
func (x *PortRange) GetStart() int64 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *PortRange) GetStop() int64 {
	if x != nil {
		return x.Stop
	}
	return 0
...
var file_set_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x79, 0x22, 0x35, 0x0a, 0x09, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x61, 0x6e, 0x67, 0x65,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x74, 0x6f, 0x70, 0x22, 0x33, 0x0a, 0x19, 0x53, 0x65,
