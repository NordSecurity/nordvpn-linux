...
const (
	...
	resolvConfComment    = "# Dynamic resolv.conf(5) file for glibc resolver(3) generated by resolvconf(8)"
	resolvConfLinkTarget = "/run/resolvconf/resolv.conf"
)
...
func (d *DNSServiceSetter) getManagementServiceBasedOnResolvconfComment() (dnsManagementService, error) {
	...
	if strings.Contains(string(resolvConfFileContents), resolvConfComment) {
