...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ACCOUNTRESPONSE']._serialized_end=465
  _globals['_ACCOUNTREQUEST']._serialized_start=467
  _globals['_ACCOUNTREQUEST']._serialized_end=497
