...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ACCOUNTRESPONSE']._serialized_end=386
  _globals['_ACCOUNTREQUEST']._serialized_start=388
  _globals['_ACCOUNTREQUEST']._serialized_end=418
