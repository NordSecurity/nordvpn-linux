...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ACCOUNTRESPONSE']._serialized_end=466
  _globals['_ACCOUNTREQUEST']._serialized_start=468
  _globals['_ACCOUNTREQUEST']._serialized_end=498
