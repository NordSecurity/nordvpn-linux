...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETTINGS']._serialized_end=857
  _globals['_USERSPECIFICSETTINGS']._serialized_start=859
  _globals['_USERSPECIFICSETTINGS']._serialized_end=924
