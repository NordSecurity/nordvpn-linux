...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETTINGS']._serialized_end=815
  _globals['_USERSPECIFICSETTINGS']._serialized_start=817
  _globals['_USERSPECIFICSETTINGS']._serialized_end=882
