...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETTINGS']._serialized_end=836
  _globals['_USERSPECIFICSETTINGS']._serialized_start=838
  _globals['_USERSPECIFICSETTINGS']._serialized_end=903
