...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETTINGS']._serialized_end=821
  _globals['_USERSPECIFICSETTINGS']._serialized_start=823
  _globals['_USERSPECIFICSETTINGS']._serialized_end=888
