...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETTINGS']._serialized_end=832
  _globals['_USERSPECIFICSETTINGS']._serialized_start=834
  _globals['_USERSPECIFICSETTINGS']._serialized_end=899
