...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETTINGS']._serialized_end=834
  _globals['_USERSPECIFICSETTINGS']._serialized_start=836
  _globals['_USERSPECIFICSETTINGS']._serialized_end=901
