...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETTINGS']._serialized_end=801
  _globals['_USERSPECIFICSETTINGS']._serialized_start=803
  _globals['_USERSPECIFICSETTINGS']._serialized_end=868
