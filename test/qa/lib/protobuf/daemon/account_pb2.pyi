...
class AccountResponse(_message.Message):
    __slots__ = ("type", "username", "email", "subscription_expires_at", "dedicated_ip_status", "last_dedicated_ip_expires_at", "dedicated_ip_services", "mfa_status", "created_on", "dedicated_servers_status", "dedicated_servers_service_expires_at")
    ...
    DEDICATED_SERVERS_STATUS_FIELD_NUMBER: _ClassVar[int]
