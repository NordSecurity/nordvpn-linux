...
class Settings(_message.Message):
    __slots__ = ("technology", "firewall", "kill_switch", "auto_connect_data", "meshnet", "routing", "fwmark", "analytics_consent", "dns", "threat_protection_lite", "protocol", "lan_discovery", "allowlist", "obfuscate", "postquantum_vpn", "user_settings", "arp_ignore", "ech")
