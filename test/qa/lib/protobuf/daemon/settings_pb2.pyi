...
class Settings(_message.Message):
    __slots__ = ("technology", "firewall", "kill_switch", "auto_connect_data", "ipv6", "meshnet", "routing", "fwmark", "analytics", "dns", "threat_protection_lite", "protocol", "lan_discovery", "allowlist", "obfuscate", "virtualLocation", "postquantum_vpn", "user_settings")
    ...
    def __init__(self, technology: _Optional[_Union[_technology_pb2.Technology, str]] = ..., firewall: bool = ..., kill_switch: bool = ..., auto_connect_data: _Optional[_Union[AutoconnectData, _Mapping]] = ..., ipv6: bool = ..., meshnet: bool = ..., routing: bool = ..., fwmark: _Optional[int] = ..., analytics: bool = ..., dns: _Optional[_Iterable[str]] = ..., threat_protection_lite: bool = ..., protocol: _Optional[_Union[_protocol_pb2.Protocol, str]] = ..., lan_discovery: bool = ..., allowlist: _Optional[_Union[_common_pb2.Allowlist, _Mapping]] = ..., obfuscate: bool = ..., virtualLocation: bool = ..., postquantum_vpn: bool = ..., user_settings: _Optional[_Union[UserSpecificSettings, _Mapping]] = ...) -> None: ...
