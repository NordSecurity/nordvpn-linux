...
def test_meshnet_connect():
    ...
    peer = meshnet.populate_peer_list_object(sh.nordvpn.mesh.peer.list()).get_external_peer()
...
def test_mesh_removed_machine_by_other():
    ...
    myname = meshnet.populate_peer_list_object(sh.nordvpn.mesh.peer.list()).get_this_device().hostname
...
def test_allowlist_incoming_connection():
    ...
    peer_hostname = meshnet.populate_peer_list_object(sh.nordvpn.mesh.peer.list()).get_external_peer().hostname
...
def test_exitnode_permissions(routing: bool, local: bool, incoming: bool, fileshare: bool):
    peer_ip = meshnet.populate_peer_list_object(sh.nordvpn.mesh.peer.list()).get_external_peer().ip
...
def test_connect_set_mesh_off():
    peer = meshnet.populate_peer_list_object(sh.nordvpn.mesh.peer.list()).get_external_peer().hostname
