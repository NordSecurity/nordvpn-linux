...
@pytest.fixture
def config_manager(default_config: dict
) -> RemoteConfigManager:
    """
...
@pytest.fixture
def clean_cache_dir(config_manager):
    """
    Fixture to clean up the "LOCAL_CACHE_DIR" directory before running tests.

    :param config_manager: An instance of the "RemoteConfigManager" class.
    """
    if config_manager.set_permissions_cache_dir():
